<script setup>
import { ElBreadcrumb, ElBreadcrumbItem, ElInput, ElCard, ElRow, ElCol, ElButton, ElDialog, ElForm, ElFormItem, ElSelect, ElOption, ElUpload } from "element-plus";
                                ...
                                <el-col class="left-item" :sm="12" :lg="8">
                                    <el-card shadow="never">
                                        <div class="firstPicture">
                                            <h1 style="margin: 5px auto">博客首图 &nbsp;&nbsp;<el-button size="mini" circle
                                                    type="primary" @click="editPic(scope.row)"><i
                ...
                <el-table-column label="操作" width="90px">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" icon="el-icon-edit" size="mini" circle
                            @click="editBlogByid(scope.row)"></el-button>
                        <!--            删除按钮-->
                        <el-button type="danger" icon="el-icon-delete" size="mini" circle
                            @click="removeBlogById(scope.row.id)"></el-button>
                    </template>
                </el-table-column>
            </el-table>
